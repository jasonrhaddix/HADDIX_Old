...
var sp_sphere_2_wire,
	sp_sphere_2_wire_mat,
	sp_sphere_2_wire_vertices,
	sp_sphere_2_particles,
	sp_sphere_2_particles_geom;
...
function sp_InitTwitch()
{
    ...
    function loop()
    {
        ...
        tweenA = TweenMax.to( tempA, 0.5, { y : tempA.y + THREE.Math.randFloat( -1, 1 ), ease: Power4.easeOut } )
        tweenB = TweenMax.to( tempB, 0.5, { y : tempB.y + THREE.Math.randFloat( -1, 1 ), ease: Power4.easeOut } )
        tweenC = TweenMax.to( tempC, 0.5, { y : tempC.y + THREE.Math.randFloat( -1, 1 ), ease: Power4.easeOut } )
...
function sp_initMouseMove( event )
{
    ...
    if ( intersects.length > 0 ) {
        ...
        {
            var faceTween1 = TweenMax.fromTo(sp_sphere_1_solid_faces[intersects[i].faceIndex].color, 0.75, {r: 5, g: 0, b: 20},{r: 1, g: 1, b: 1})  
               
            try {    
                var faceTween2 = TweenMax.fromTo(sp_sphere_1_solid_faces[intersects[i].faceIndex+1].color, 0.75, {r: 5, g: 5, b: 0},{r: 1, g: 1, b: 1})   
            } catch(error){}
            ...
            {
                var temp = sp_sphere_1_solid_faces[intersects[i].faceIndex];                 
                ...
                var t1 = TweenMax.to( tempA, 0.3, { y : tempA.y + THREE.Math.randFloat( 0.1, 0.3 ), ease: Expo.easeOut } )
                var t2 = TweenMax.to( tempB, 0.3, { y : tempB.y + THREE.Math.randFloat( 0.1, 0.3 ), ease: Expo.easeOut } )
                var t3 = TweenMax.to( tempC, 0.3, { y : tempC.y + THREE.Math.randFloat( 0.1, 0.3 ), ease: Expo.easeOut } )
