...
const About_Clients = () => {
	return (
		<div className="about-content about-experience-container">
			<div className="about-experience-inner">
				<div className="about-section-content">
					...
					<div className="about-subsection">
						...
						<div className="about-experience-role"><h4>Senior Developer<span> | 2007 - 2016</span></h4></div>
						...
						<div className="about-section-experience-roles">
							<p>Roles Included :</p>
							<ul>
					...
					<div className="about-subsection">
						...
						<div className="about-experience-role"><h4>Contract Developer<span> | 2007 - PRESENT</span></h4></div>
					...
					<div className="about-subsection">
						<h3>Dot Squirrels</h3>
						<div className="about-experience-role"><h4>Contract Developer<span> | 2016 - PRESENT</span></h4></div>
